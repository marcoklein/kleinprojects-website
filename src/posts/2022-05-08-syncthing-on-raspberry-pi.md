...
<h3 data-heading="Raspberry Pi as Syncthing Main Server">Raspberry Pi as Syncthing Main Server</h3>
...
<h3 data-heading="Setting up the SD Card">Setting up the SD Card</h3>
...
<h3 data-heading="Connecting to the Raspberry PI">Connecting to the Raspberry PI</h3>
...
<h3 data-heading="Installing Syncthing">Installing Syncthing</h3>
...
<h3 data-heading="Exposing the Syncthing Web Console">Exposing the Syncthing Web Console</h3>
...
<p>To run Syncthing on startup (e.g. when the Raspberry Pi powers up), we can edit the <code>/etc/rc.local</code> file that gets executed on startup:</p>
<pre class="language-sh" tabindex="0"><code class="language-sh is-loaded">sudo vi /etc/rc.local
</code><button class="copy-code-button">Copy</button></pre>
...
<h3 data-heading="Conclusion">Conclusion</h3>
